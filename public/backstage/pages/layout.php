...
$__adminRole   = $__backstageRole === 'global_system_administrator'
    ? 'Global System Administrator'
    : 'Administrator';
$__pageTitle   = htmlspecialchars($pageTitle ?? 'Dashboard', ENT_QUOTES, 'UTF-8');
...
<head>
    ...
    <title><?= $__pageTitle ?> — Daems Backstage</title>
...
<aside class="sidebar" id="sidebar" role="navigation" aria-label="Admin navigation">
                ...
                <li>
                    <a href="/backstage/insights" class="sidebar__item <?= $__isActive('insights') ?>"
                       <?= $__activePage === 'insights' ? 'aria-current="page"' : '' ?>>
                        ...
                        <span class="sidebar__label">Insights</span>
                    </a>
                </li>
                <li>
    ...
    <div class="sidebar__footer">
        <a href="/" class="sidebar__footer-link" aria-label="Return to public site">
...
<div class="main-area">
    <header class="header-bar">
        <div class="header-bar__left">
            <button class="sidebar-toggle" id="sidebar-toggle" aria-label="Open navigation" aria-expanded="false">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                    <line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/>
                </svg>
            </button>

            <button class="search-trigger" id="search-trigger" aria-label="Search (Ctrl+K)">
            ...
            <nav class="breadcrumb" aria-label="Breadcrumb">
                <a href="/backstage" class="breadcrumb__link">Backstage</a>
        ...
        <div class="header-bar__right">
            <?php if ($__tenantName !== null): ?>
                <span class="header-bar__tenant" title="Aktiivinen tenant">
                    <?= htmlspecialchars($__tenantName, ENT_QUOTES, 'UTF-8') ?>
                </span>
            <?php endif; ?>

            <!-- Theme toggle -->
            <button class="header-bar__action" id="theme-toggle" aria-label="Toggle theme">
            ...
            <div class="user-dropdown" id="user-dropdown">
                <button class="user-dropdown__trigger" id="user-dropdown-trigger" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="user-dropdown__info">
                        ...
                        <span class="user-dropdown__role">GSA</span>
                    </div>
                ...
                <div class="user-dropdown__menu" role="menu">
                    ...
                    <div class="user-dropdown__divider"></div>
                    <span class="user-dropdown__item" role="menuitem" aria-disabled="true">View as…</span>
                    ...
                    <?php endif; ?>
                    <div class="user-dropdown__divider"></div>
                    <a href="/logout" class="user-dropdown__item user-dropdown__item--danger" role="menuitem">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
...
<nav class="bottom-nav" aria-label="Main navigation">
    ...
    <a href="/backstage/members" class="bottom-nav__item <?= $__isActive('members') ?>">
        ...
        <span class="bottom-nav__label">Members</span>
    </a>
...
<div class="cmd-palette" id="cmd-palette" hidden>
    ...
    <div class="cmd-palette__panel" role="combobox" aria-expanded="true" aria-haspopup="listbox" aria-label="Search">
        <div class="cmd-palette__header">
            ...
            <input class="cmd-palette__input" id="cmd-palette-input" type="text" placeholder="Search admin..." autocomplete="off" aria-autocomplete="list" aria-controls="cmd-palette-list">
        </div>
        <ul class="cmd-palette__list" id="cmd-palette-list" role="listbox">
            <li class="cmd-palette__item" role="option" data-href="/backstage"><span class="cmd-palette__item-label">Dashboard</span><span class="cmd-palette__item-section">Main</span></li>
            <li class="cmd-palette__item" role="option" data-href="/backstage/members"><span class="cmd-palette__item-label">Members</span><span class="cmd-palette__item-section">Main</span></li>
            <li class="cmd-palette__item" role="option" data-href="/backstage/members?view=pending"><span class="cmd-palette__item-label">Pending applications</span><span class="cmd-palette__item-section">Main</span></li>
            <li class="cmd-palette__item" role="option" data-href="/backstage/events"><span class="cmd-palette__item-label">Events</span><span class="cmd-palette__item-section">Main</span></li>
            <li class="cmd-palette__item" role="option" data-href="/backstage/projects"><span class="cmd-palette__item-label">Projects</span><span class="cmd-palette__item-section">Main</span></li>
            <li class="cmd-palette__item" role="option" data-href="/backstage/forum"><span class="cmd-palette__item-label">Forum</span><span class="cmd-palette__item-section">Main</span></li>
            <li class="cmd-palette__item" role="option" data-href="/backstage/notifications"><span class="cmd-palette__item-label">Notifications</span><span class="cmd-palette__item-section">System</span></li>
            <li class="cmd-palette__item" role="option" data-href="/backstage/settings"><span class="cmd-palette__item-label">Settings</span><span class="cmd-palette__item-section">System</span></li>
            <li class="cmd-palette__item" role="option" data-href="/"><span class="cmd-palette__item-label">Public site</span><span class="cmd-palette__item-section">Navigation</span></li>
        </ul>
        <div class="cmd-palette__empty" id="cmd-palette-empty" hidden>No results found.</div>
...
(function () {
    ...
    if (!el) return;
    var now = new Date();
    el.textContent = now.toLocaleTimeString('fi-FI', {hour:'2-digit', minute:'2-digit', second:'2-digit'});
})();
</script>
</body>
</html>
