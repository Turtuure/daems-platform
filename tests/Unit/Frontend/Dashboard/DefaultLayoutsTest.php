...
final class DefaultLayoutsTest extends TestCase
{
    public function test_admin_default_has_expected_widgets(): void
    {
        ...
        // + 4 added in MembershipCore 0.6b (governance widgets).
        self::assertCount(13, $layout);
        ...
        self::assertContains('governance.pending_decisions_for_me_kpi', $ids);
        self::assertContains('governance.open_expulsions_kpi', $ids);
        self::assertContains('governance.delegations_active_kpi', $ids);
        self::assertContains('governance.eligible_for_full_membership', $ids);
    }
