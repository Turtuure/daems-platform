...
namespace Daems\Tests\Unit\Application\Backstage\Platform\RevokeAdminFromUserForTenant;
...
final class RevokeAdminFromUserForTenantTest extends TestCase
{
    ...
    private RevokeAdminFromUserForTenant $uc;
    ...
    protected function setUp(): void
    {
        ...
        // Seed target as admin so we have something to revoke.
        $this->userTenants->attach(
            UserId::fromString(self::TARGET_ID),
            TenantId::fromString(self::TENANT_ID),
            UserTenantRole::Admin,
        );
        $this->uc = new RevokeAdminFromUserForTenant($this->userTenants, $this->users);
    }

    public function test_revokes_admin_to_member(): void
    {
        $this->uc->execute(new RevokeAdminFromUserForTenantInput(
        ...
        self::assertSame(UserTenantRole::Member, $role);
    }
